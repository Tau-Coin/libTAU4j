...
import org.libTAU4j.swig.entry_vector;
...
public final class Entry {
    ...
    private static final class EntryMap extends AbstractMap<String, Entry> {
        ...
        @Override
        public org.libTAU4j.Entry get(Object key) {
            String k = key.toString();
            return m.contains(k) ? new org.libTAU4j.Entry(m.get(key.toString())) : null;
        }

        @Override
        public org.libTAU4j.Entry put(String key, org.libTAU4j.Entry value) {
            org.libTAU4j.Entry r = get(key);
        ...
        @Override
        public Set<Entry<String, org.libTAU4j.Entry>> entrySet() {
