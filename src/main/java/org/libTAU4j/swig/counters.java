...
public class counters {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_counters(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public counters() {
    this(libTAU_jni.new_counters__SWIG_0(), true);
  }

  public counters(counters arg0) {
    this(libTAU_jni.new_counters__SWIG_1(counters.getCPtr(arg0), arg0), true);
  }

  public long inc_stats_counter(int c, long value) {
    return libTAU_jni.counters_inc_stats_counter__SWIG_0(swigCPtr, this, c, value);
  }

  public long inc_stats_counter(int c) {
    return libTAU_jni.counters_inc_stats_counter__SWIG_1(swigCPtr, this, c);
  }

  public long at(int i) {
    return libTAU_jni.counters_at(swigCPtr, this, i);
  }

  public void set_value(int c, long value) {
    libTAU_jni.counters_set_value(swigCPtr, this, c, value);
  }

  public void blend_stats_counter(int c, long value, int ratio) {
    libTAU_jni.counters_blend_stats_counter(swigCPtr, this, c, value, ratio);
  }
  ...
  public final static class stats_gauge_t {
    public final static counters.stats_gauge_t num_checking_torrents = new counters.stats_gauge_t("num_checking_torrents", libTAU_jni.counters_num_checking_torrents_get());
    ...
    public final static counters.stats_gauge_t num_gauges_counters = new counters.stats_gauge_t("num_gauges_counters", libTAU_jni.counters_num_gauges_counters_get());
