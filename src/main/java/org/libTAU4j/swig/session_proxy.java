...
public class session_proxy {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_session_proxy(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public session_proxy() {
    this(libTAU_jni.new_session_proxy__SWIG_0(), true);
  }

  public session_proxy(session_proxy arg0) {
    this(libTAU_jni.new_session_proxy__SWIG_1(session_proxy.getCPtr(arg0), arg0), true);
  }
