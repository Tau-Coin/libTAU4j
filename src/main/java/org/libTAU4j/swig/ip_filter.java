...
public class ip_filter {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_ip_filter(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public ip_filter() {
    this(libTAU_jni.new_ip_filter__SWIG_0(), true);
  }

  public ip_filter(ip_filter arg0) {
    this(libTAU_jni.new_ip_filter__SWIG_1(ip_filter.getCPtr(arg0), arg0), true);
  }

  public boolean empty() {
    return libTAU_jni.ip_filter_empty(swigCPtr, this);
  }

  public void add_rule(address first, address last, long flags) {
    libTAU_jni.ip_filter_add_rule(swigCPtr, this, address.getCPtr(first), first, address.getCPtr(last), last, flags);
  }

  public long access(address addr) {
    return libTAU_jni.ip_filter_access(swigCPtr, this, address.getCPtr(addr), addr);
  }

  public final static class access_flags {
    public final static ip_filter.access_flags blocked = new ip_filter.access_flags("blocked", libTAU_jni.ip_filter_blocked_get());
