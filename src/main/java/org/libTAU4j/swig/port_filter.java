...
public class port_filter {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_port_filter(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public port_filter() {
    this(libTAU_jni.new_port_filter__SWIG_0(), true);
  }

  public port_filter(port_filter arg0) {
    this(libTAU_jni.new_port_filter__SWIG_1(port_filter.getCPtr(arg0), arg0), true);
  }

  public void add_rule(int first, int last, long flags) {
    libTAU_jni.port_filter_add_rule(swigCPtr, this, first, last, flags);
  }

  public long access(int port) {
    return libTAU_jni.port_filter_access(swigCPtr, this, port);
  }

  public final static class access_flags {
    public final static port_filter.access_flags blocked = new port_filter.access_flags("blocked", libTAU_jni.port_filter_blocked_get());
