...
public class client_data_t {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_client_data_t(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public client_data_t() {
    this(libTAU_jni.new_client_data_t__SWIG_0(), true);
  }

  public client_data_t(long arg0) {
    this(libTAU_jni.new_client_data_t__SWIG_1(arg0), true);
  }

  public long get() {
    return libTAU_jni.client_data_t_get(swigCPtr, this);
  }
