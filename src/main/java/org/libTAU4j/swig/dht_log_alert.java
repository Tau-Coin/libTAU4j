...
public class dht_log_alert extends alert {
  ...
  protected dht_log_alert(long cPtr, boolean cMemoryOwn) {
    super(libTAU_jni.dht_log_alert_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_dht_log_alert(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public int type() {
    return libTAU_jni.dht_log_alert_type(swigCPtr, this);
  }

  public alert_category_t category() {
    return new alert_category_t(libTAU_jni.dht_log_alert_category(swigCPtr, this), true);
  }

  public String what() {
    return libTAU_jni.dht_log_alert_what(swigCPtr, this);
  }

  public String message() {
    return libTAU_jni.dht_log_alert_message(swigCPtr, this);
  }

  public String log_message() {
    return libTAU_jni.dht_log_alert_log_message(swigCPtr, this);
  }

  public void setModule(dht_log_alert.dht_module_t value) {
    libTAU_jni.dht_log_alert_module_set(swigCPtr, this, value.swigValue());
  }

  public dht_log_alert.dht_module_t getModule() {
    return dht_log_alert.dht_module_t.swigToEnum(libTAU_jni.dht_log_alert_module_get(swigCPtr, this));
  }
  ...
  public final static alert_category_t static_category = new alert_category_t(libTAU_jni.dht_log_alert_static_category_get(), false);
  public final static alert_priority priority = alert_priority.swigToEnum(libTAU_jni.dht_log_alert_priority_get());
  public final static int alert_type = libTAU_jni.dht_log_alert_alert_type_get();
}
