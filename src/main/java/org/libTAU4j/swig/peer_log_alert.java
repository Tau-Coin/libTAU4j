...
public class peer_log_alert extends peer_alert {
  ...
  protected peer_log_alert(long cPtr, boolean cMemoryOwn) {
    super(libTAU_jni.peer_log_alert_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_peer_log_alert(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public int type() {
    return libTAU_jni.peer_log_alert_type(swigCPtr, this);
  }

  public alert_category_t category() {
    return new alert_category_t(libTAU_jni.peer_log_alert_category(swigCPtr, this), true);
  }

  public String what() {
    return libTAU_jni.peer_log_alert_what(swigCPtr, this);
  }

  public String message() {
    return libTAU_jni.peer_log_alert_message(swigCPtr, this);
  }

  public void setDirection(peer_log_alert.direction_t value) {
    libTAU_jni.peer_log_alert_direction_set(swigCPtr, this, value.swigValue());
  }

  public peer_log_alert.direction_t getDirection() {
    return peer_log_alert.direction_t.swigToEnum(libTAU_jni.peer_log_alert_direction_get(swigCPtr, this));
  }

  public String log_message() {
    return libTAU_jni.peer_log_alert_log_message(swigCPtr, this);
  }

  public String get_event_type() {
    return libTAU_jni.peer_log_alert_get_event_type(swigCPtr, this);
  }
  ...
  public final static alert_priority priority = alert_priority.swigToEnum(libTAU_jni.peer_log_alert_priority_get());
  public final static int alert_type = libTAU_jni.peer_log_alert_alert_type_get();
  public final static alert_category_t static_category = new alert_category_t(libTAU_jni.peer_log_alert_static_category_get(), false);
}
