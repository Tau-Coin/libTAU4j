...
public class settings_pack extends settings_interface {
  ...
  protected settings_pack(long cPtr, boolean cMemoryOwn) {
    super(libTAU_jni.settings_pack_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libTAU_jni.delete_settings_pack(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public settings_pack() {
    this(libTAU_jni.new_settings_pack__SWIG_0(), true);
  }

  public settings_pack(settings_pack arg0) {
    this(libTAU_jni.new_settings_pack__SWIG_1(settings_pack.getCPtr(arg0), arg0), true);
  }

  public void set_str(int name, String val) {
    libTAU_jni.settings_pack_set_str(swigCPtr, this, name, val);
  }

  public void set_int(int name, int val) {
    libTAU_jni.settings_pack_set_int(swigCPtr, this, name, val);
  }

  public void set_bool(int name, boolean val) {
    libTAU_jni.settings_pack_set_bool(swigCPtr, this, name, val);
  }

  public boolean has_val(int name) {
    return libTAU_jni.settings_pack_has_val(swigCPtr, this, name);
  }

  public void clear() {
    libTAU_jni.settings_pack_clear__SWIG_0(swigCPtr, this);
  }

  public void clear(int name) {
    libTAU_jni.settings_pack_clear__SWIG_1(swigCPtr, this, name);
  }

  public String get_str(int name) {
    return libTAU_jni.settings_pack_get_str(swigCPtr, this, name);
  }

  public int get_int(int name) {
    return libTAU_jni.settings_pack_get_int(swigCPtr, this, name);
  }

  public boolean get_bool(int name) {
    return libTAU_jni.settings_pack_get_bool(swigCPtr, this, name);
  }

  public byte_vector get_bytes(int name) {
    return new byte_vector(libTAU_jni.settings_pack_get_bytes(swigCPtr, this, name), true);
  }

  public void set_bytes(int name, byte_vector v) {
    libTAU_jni.settings_pack_set_bytes(swigCPtr, this, name, byte_vector.getCPtr(v), v);
  }

  public final static class type_bases {
    public final static settings_pack.type_bases string_type_base = new settings_pack.type_bases("string_type_base", libTAU_jni.settings_pack_string_type_base_get());
    public final static settings_pack.type_bases int_type_base = new settings_pack.type_bases("int_type_base", libTAU_jni.settings_pack_int_type_base_get());
    public final static settings_pack.type_bases bool_type_base = new settings_pack.type_bases("bool_type_base", libTAU_jni.settings_pack_bool_type_base_get());
    public final static settings_pack.type_bases type_mask = new settings_pack.type_bases("type_mask", libTAU_jni.settings_pack_type_mask_get());
    public final static settings_pack.type_bases index_mask = new settings_pack.type_bases("index_mask", libTAU_jni.settings_pack_index_mask_get());
  ...
  public final static class string_types {
    public final static settings_pack.string_types user_agent = new settings_pack.string_types("user_agent", libTAU_jni.settings_pack_user_agent_get());
    public final static settings_pack.string_types announce_ip = new settings_pack.string_types("announce_ip");
    public final static settings_pack.string_types handshake_client_version = new settings_pack.string_types("handshake_client_version", libTAU_jni.settings_pack_handshake_client_version_get());
  ...
  public final static class bool_types {
    public final static settings_pack.bool_types allow_multiple_connections_per_ip = new settings_pack.bool_types("allow_multiple_connections_per_ip", libTAU_jni.settings_pack_allow_multiple_connections_per_ip_get());
    public final static settings_pack.bool_types send_redundant_have = new settings_pack.bool_types("send_redundant_have", libTAU_jni.settings_pack_send_redundant_have_get());
    public final static settings_pack.bool_types use_dht_as_fallback = new settings_pack.bool_types("use_dht_as_fallback", libTAU_jni.settings_pack_use_dht_as_fallback_get());
    ...
    public final static settings_pack.bool_types auto_manage_prefer_seeds = new settings_pack.bool_types("auto_manage_prefer_seeds", libTAU_jni.settings_pack_auto_manage_prefer_seeds_get());
    ...
    public final static settings_pack.bool_types disable_hash_checks = new settings_pack.bool_types("disable_hash_checks", libTAU_jni.settings_pack_disable_hash_checks_get());
    public final static settings_pack.bool_types allow_i2p_mixed = new settings_pack.bool_types("allow_i2p_mixed");
    public final static settings_pack.bool_types no_atime_storage = new settings_pack.bool_types("no_atime_storage", libTAU_jni.settings_pack_no_atime_storage_get());
    ...
    public final static settings_pack.bool_types enable_outgoing_utp = new settings_pack.bool_types("enable_outgoing_utp", libTAU_jni.settings_pack_enable_outgoing_utp_get());
    ...
    public final static settings_pack.bool_types no_recheck_incomplete_resume = new settings_pack.bool_types("no_recheck_incomplete_resume", libTAU_jni.settings_pack_no_recheck_incomplete_resume_get());
    ...
    public final static settings_pack.bool_types seeding_outgoing_connections = new settings_pack.bool_types("seeding_outgoing_connections", libTAU_jni.settings_pack_seeding_outgoing_connections_get());
    ...
    public final static settings_pack.bool_types ban_web_seeds = new settings_pack.bool_types("ban_web_seeds", libTAU_jni.settings_pack_ban_web_seeds_get());
    ...
    public final static settings_pack.bool_types support_share_mode = new settings_pack.bool_types("support_share_mode", libTAU_jni.settings_pack_support_share_mode_get());
    public final static settings_pack.bool_types report_redundant_bytes = new settings_pack.bool_types("report_redundant_bytes", libTAU_jni.settings_pack_report_redundant_bytes_get());
    ...
    public final static settings_pack.bool_types announce_crypto_support = new settings_pack.bool_types("announce_crypto_support", libTAU_jni.settings_pack_announce_crypto_support_get());
  ...
  public final static class int_types {
    public final static settings_pack.int_types tracker_completion_timeout = new settings_pack.int_types("tracker_completion_timeout", libTAU_jni.settings_pack_tracker_completion_timeout_get());
    ...
    public final static settings_pack.int_types disk_io_write_mode = new settings_pack.int_types("disk_io_write_mode", libTAU_jni.settings_pack_disk_io_write_mode_get());
    ...
    public final static settings_pack.int_types auto_manage_interval = new settings_pack.int_types("auto_manage_interval", libTAU_jni.settings_pack_auto_manage_interval_get());
    ...
    public final static settings_pack.int_types read_cache_line_size = new settings_pack.int_types("read_cache_line_size", libTAU_jni.settings_pack_read_cache_line_size_get());
    ...
    public final static settings_pack.int_types num_optimistic_unchoke_slots = new settings_pack.int_types("num_optimistic_unchoke_slots", libTAU_jni.settings_pack_num_optimistic_unchoke_slots_get());
    public final static settings_pack.int_types max_pex_peers = new settings_pack.int_types("max_pex_peers", libTAU_jni.settings_pack_max_pex_peers_get());
    ...
    public final static settings_pack.int_types dht_upload_rate_limit = new settings_pack.int_types("dht_upload_rate_limit", libTAU_jni.settings_pack_dht_upload_rate_limit_get());
    public final static settings_pack.int_types unchoke_slots_limit = new settings_pack.int_types("unchoke_slots_limit");
    public final static settings_pack.int_types connections_limit = new settings_pack.int_types("connections_limit", libTAU_jni.settings_pack_connections_limit_get());
    ...
    public final static settings_pack.int_types utp_loss_multiplier = new settings_pack.int_types("utp_loss_multiplier", libTAU_jni.settings_pack_utp_loss_multiplier_get());
    ...
    public final static settings_pack.int_types tracker_backoff = new settings_pack.int_types("tracker_backoff", libTAU_jni.settings_pack_tracker_backoff_get());
    ...
    public final static settings_pack.int_types urlseed_max_request_bytes = new settings_pack.int_types("urlseed_max_request_bytes", libTAU_jni.settings_pack_urlseed_max_request_bytes_get());
  ...
  public final static class choking_algorithm_t {
    public final static settings_pack.choking_algorithm_t fixed_slots_choker = new settings_pack.choking_algorithm_t("fixed_slots_choker", libTAU_jni.settings_pack_fixed_slots_choker_get());
    public final static settings_pack.choking_algorithm_t rate_based_choker = new settings_pack.choking_algorithm_t("rate_based_choker", libTAU_jni.settings_pack_rate_based_choker_get());
  ...
  public final static class io_buffer_mode_t {
    public final static settings_pack.io_buffer_mode_t enable_os_cache = new settings_pack.io_buffer_mode_t("enable_os_cache", libTAU_jni.settings_pack_enable_os_cache_get());
    public final static settings_pack.io_buffer_mode_t disable_os_cache = new settings_pack.io_buffer_mode_t("disable_os_cache", libTAU_jni.settings_pack_disable_os_cache_get());
  ...
  public final static class bandwidth_mixed_algo_t {
    public final static settings_pack.bandwidth_mixed_algo_t prefer_tcp = new settings_pack.bandwidth_mixed_algo_t("prefer_tcp", libTAU_jni.settings_pack_prefer_tcp_get());
    public final static settings_pack.bandwidth_mixed_algo_t peer_proportional = new settings_pack.bandwidth_mixed_algo_t("peer_proportional", libTAU_jni.settings_pack_peer_proportional_get());
  ...
  public final static class enc_level {
    public final static settings_pack.enc_level pe_plaintext = new settings_pack.enc_level("pe_plaintext", libTAU_jni.settings_pack_pe_plaintext_get());
    public final static settings_pack.enc_level pe_rc4 = new settings_pack.enc_level("pe_rc4", libTAU_jni.settings_pack_pe_rc4_get());
    public final static settings_pack.enc_level pe_both = new settings_pack.enc_level("pe_both", libTAU_jni.settings_pack_pe_both_get());
