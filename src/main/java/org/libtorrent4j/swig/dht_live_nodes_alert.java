...
public class dht_live_nodes_alert extends alert {
  ...
  public void setNode_id(sha256_hash value) {
    libtorrent_jni.dht_live_nodes_alert_node_id_set(swigCPtr, this, sha256_hash.getCPtr(value), value);
  }
  ...
  public sha256_hash_udp_endpoint_pair_vector nodes() {
    return new sha256_hash_udp_endpoint_pair_vector(libtorrent_jni.dht_live_nodes_alert_nodes(swigCPtr, this), true);
  }
