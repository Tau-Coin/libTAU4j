...
public class announce_endpoint_vector {
  ...
  public announce_endpoint_vector(long n) {
    this(libtorrent_jni.new_announce_endpoint_vector__SWIG_1(n), true);
  }
  ...
  public void add(announce_endpoint x) {
    libtorrent_jni.announce_endpoint_vector_add(swigCPtr, this, announce_endpoint.getCPtr(x), x);
  }
