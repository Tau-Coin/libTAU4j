...
source build-utils-arm32-ndk24.shinc
check_min_req_vars
...
sed -i 's/RANLIB = ranlib/RANLIB = "${ANDROID_TOOLCHAIN}\/bin\/llvm-ranlib"/g' ${BOOST_ROOT}/tools/build/src/tools/gcc.jam;
