...
${ANDROID_TOOLCHAIN}/bin/llvm-objcopy --only-keep-debug bin/release/android/x86_64/libTAU4j.so bin/release/android/x86_64/libTAU4j.so.debug
${ANDROID_TOOLCHAIN}/bin/llvm-strip --strip-unneeded -x bin/release/android/x86_64/libTAU4j.so
${ANDROID_TOOLCHAIN}/bin/llvm-readelf -d bin/release/android/x86_64/libTAU4j.so
